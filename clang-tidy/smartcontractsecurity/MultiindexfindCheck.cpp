//===--- MultiindexfindCheck.cpp - clang-tidy------------------------------===//
//
...
void MultiindexfindCheck::registerMatchers(MatchFinder *Finder) {
...
void MultiindexfindCheck::check(const MatchFinder::MatchResult &Result) {
